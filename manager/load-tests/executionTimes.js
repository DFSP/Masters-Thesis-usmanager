...
const params = {headers: {"Authorization": `Basic ${encoding.b64encode("admin:admin")}`, "Content-Type": "application/json", timeout: 180000}};
...
export default function() {
    ...
    let checkRes = check(response, {
        ...
        "duration is over 0": (r) => r.timings.duration > 0,
    });
